...
export const SPONSORS: Sponsor[] = [
  ...
  },
  {
    ...
    contacts: [{ name: "", email: "", title: "" }],
    currentDri: "Liza Mehta",
    years: [{ year: 2026, tier: "silver", addOns: [], dri: "Liza Mehta", reps: [] }],
    historyKeyword: "Confirmed", status: "Confirmed Sponsor",
  ...
  },
  {
    ...
    contacts: [{ name: "", email: "", title: "" }],
    currentDri: "Mahek Patel",
    years: [{ year: 2026, tier: "silver", addOns: [], dri: "Mahek Patel", reps: [] }],
    historyKeyword: "Confirmed", status: "Confirmed Sponsor",
  ...
  },
  {
    ...
    contacts: [{ name: "", email: "", title: "" }],
    currentDri: "Diya Saxena",
    years: [{ year: 2026, tier: "silver", addOns: [], dri: "Diya Saxena", reps: [] }],
    historyKeyword: "Confirmed", status: "Confirmed Sponsor",
  ...
  },
  {
    ...
    contacts: [{ name: "", email: "", title: "" }],
    currentDri: "Samantha Mac",
    years: [{ year: 2026, tier: "silver", addOns: [], dri: "Samantha Mac", reps: [] }],
    historyKeyword: "Confirmed", status: "Confirmed Sponsor",
  ...
  },
  {
    ...
    contacts: [{ name: "", email: "", title: "" }],
    currentDri: "Julia Ilioukhina",
    years: [{ year: 2026, tier: "bronze", addOns: [], dri: "Julia Ilioukhina", reps: [] }],
    historyKeyword: "Confirmed", status: "Confirmed Sponsor",
    notes: "Confirmed gold package. Meetup details pending.",
    lastBumpDate: "2026-05-23",
  ...
  },
  {
    ...
    contacts: [{ name: "", email: "", title: "" }],
    currentDri: "Anunya Kapur",
    years: [{ year: 2026, tier: "bronze", addOns: [], dri: "Anunya Kapur", reps: [] }],
    historyKeyword: "Confirmed", status: "Confirmed Sponsor",
    notes: "Confirmed gold package with two add-ons.",
    lastBumpDate: "2026-05-23",
  ...
  },
  {
    ...
    contacts: [{ name: "", email: "", title: "" }],
    currentDri: "Mahek Patel",
    years: [{ year: 2026, tier: "bronze", addOns: [], dri: "Mahek Patel", reps: [] }],
    historyKeyword: "Confirmed", status: "Confirmed Sponsor",
    notes: "Confirmed gold package with two add-ons.",
    lastBumpDate: "2026-05-23",
