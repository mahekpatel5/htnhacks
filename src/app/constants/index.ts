...
export const SPONSORS: Sponsor[] = [
  ...
  },
  {
    ...
    historyKeyword: "2026 Sponsor – Warm", status: "Discovery Call",
  ...
  },
  {
    ...
    years: [
      { year: 2022, tier: "gold", addOns: ["Design Workshop", "Swag Drop"], dri: "Julia Ilioukhina", reps: ["Lee Park", "Morgan Chu"] },
    ],
  ...
  },
  {
    ...
    currentDri: "Liza Mehta", years: [],
    historyKeyword: "Interested in 2026", status: "Warm Intro",
  ...
  },
  {
    ...
    currentDri: "Julia Ilioukhina",
    years: [{ year: 2024, tier: "startup", addOns: [], dri: "Julia Ilioukhina", reps: ["Blake Ryan"] }],
  ...
  },
  {
    ...
    currentDri: "Anunya Kapur",
    years: [
      { year: 2023, tier: "bronze", addOns: ["Recruiting Booth"], dri: "Liza Mehta", reps: ["Anna Bright"] },
      { year: 2022, tier: "bronze", addOns: ["Recruiting Booth"], dri: "Liza Mehta", reps: ["Anna Bright", "Tom Bell"] },
    ],
  ...
  },
  {
    ...
    currentDri: "me", years: [],
    historyKeyword: "New Reachouts", status: "Prospect",
    notes: "",
  ...
  },
  {
    ...
    contact: { name: "", email: "", title: "" },
    currentDri: "Julia Ilioukhina", years: [],
    historyKeyword: "New Reachouts", status: "Contacted",
    notes: "",
    lastBumpDate: "2026-05-20",
    aiSummary: "",
    recruiterFeedback: "",
  ...
  },
  {
    ...
    contact: { name: "", email: "", title: "" },
    currentDri: "Anunya Kapur", years: [],
    historyKeyword: "New Reachouts", status: "Discovery Call",
    notes: "",
    lastBumpDate: "2026-05-18",
    aiSummary: "",
    recruiterFeedback: "",
  ...
  },
  {
    ...
    contact: { name: "", email: "", title: "" },
    currentDri: "Jennifer Yu", years: [],
    historyKeyword: "New Reachouts", status: "Warm Intro",
    notes: "",
    lastBumpDate: "2026-05-15",
    aiSummary: "",
    recruiterFeedback: "",
