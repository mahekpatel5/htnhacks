  ...
  function SortHeader({
    ...
    return (
      <button
        ...
        className={
          "flex items-left justify-start gap-1 w-full text-xs font-semibold text-gray-500 uppercase tracking-wide hover:text-gray-800 transition-colors " +
          className
        }
      >
        {label}
        ...
        <table className="w-full text-sm min-w-[960px]">
          ...
          <tbody>
            {filtered.map((s) => {
              ...
              const tier2026 = s.years.find((y) => y.year === TIER_YEAR)?.tier;
              return (
                <tr
                  key={s.id}
